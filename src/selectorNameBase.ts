...
export class SelectorRule extends Lint.Rules.AbstractRule {
    ...
    public getNameFailure():any {};
    protected getSinglePrefixFailure():any {};
    protected getManyPrefixFailure():any {};
