...
var Rule = (function (_super) {
    ...
    Rule.prototype.getTypeFailure = function () { return 'The selector of the directive "%s" should be used as %s ($$02-06$$)'; };
    Rule.prototype.getStyleFailure = function () { return 'The selector of the directive "%s" should be named %s ($$02-06$$)'; };
